...
class UserListView(ListView):
    model = User
    template_name = 'admin-authapp-read.html'
...
#     context = {'authapp': User.objects.all()}
#     return render(request, 'admin-authapp-read.html', context)
...
class UserCreateView(CreateView):
    model = User
    template_name = 'admin-authapp-creat.html'
...
#         'form': form,
#     }
#     return render(request, 'admin-authapp-creat.html', context)


# UPDATE
class UserUpdateView(UpdateView):
    model = User
    template_name = 'admin-authapp-update-delete.html'
...
#     }
#
#     return render(request, 'admin-authapp-update-delete.html', context)
